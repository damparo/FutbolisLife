...
// set up  state variables for countdown timer: years, days, hours, minutes, seconds
    ...
    const startCountDown = () => {
      ...
      interval = setInterval( () => {
        ...
        // convert the difference in milliseconds to years, days, hours, minutes, and seconds
        ...
        // conditional to stop countdown after date is reached, otherwise keep updating via useState
    ...
    // useEffect hook to start countdown
    useEffect(() => {
